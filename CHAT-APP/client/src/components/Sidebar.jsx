...
const Sidebar = () => {
    ...
    const {
        getUsers, users, selectedUser, setSelectedUsers,
    ...
    const filteredUsers = input ? users.filter((user) =>
        user.fullName.toLocaleLowerCase().includes(input.toLocaleLowerCase())) : users
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='relative py-2 group'>
                        ...
                        <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142]
                             border border-gray-600 to-gray-100 hidden group-hover:block'>
            ...
            <div className='flex flex-col'>
                {
                    filteredUsers.map((user, index) => (
                        ...
                        ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}>
                            ...
                            <img src={user?.profilePic || assets.avatar_icon} alt="avarta"
