...
const ChatContainer = () => {
    ...
    const {
        messages, selectedUser, setSelectedUser, sendMessage,
        getMessages
    ...
    return selectedUser ? (
        <div className='h-full overflow-scroll relative backdrop-blur-lg'>
            ...
            <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
                <img src={selectedUser.profilePic || assets.avatar_icon} alt="profile_martin"
                ...
                <img onClick={() => setSelectedUser(null)} src={assets.arrow_icon} alt="arrow_icon"
            ...
            <div className='absolute bottom-0 left-0 -right-0 flex items-center gap-3 p-3'>
                ...
                <img onClick={handleSendImage} src={assets.send_button} alt="send_button"
